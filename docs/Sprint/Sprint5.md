...
Current Step: ContextBuilder 已完成；下一步确定 RAG Prompt 的受控注入与总 Token 预算计算
```
...
| 5.8 Citation & Context | 进行中，ContextBuilder 已完成，测试待补 | `RetrievalHit[]` 受 Token 预算选择、结构化 Citation、完整 Chunk 不截断 |
